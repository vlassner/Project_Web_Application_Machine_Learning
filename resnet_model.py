...
st.text("The ResNet, Residual Network, model is a Convolutional Neural Network (CNN). The version used below is"
        " the ResNet50 model which uses 50 layers to process the images. A unique feature of Resnet is its "
        "ability to skip layers and move deeper into the network by preventing the gradiants from vanishing. "
        "This is allows the model to learn more features in the deeper layers without it being lost")  
