...
st.text("The ViT model uses the transformer architecture. It learns by following patterns in sequential "
        "data using the self-attention mechanism. This mechanism is how it takes into account the importance of each "
        "input element while making predictions. One of the drawbacks is the lack of built-in inductive "
        "bias of locality where the model assumes pixels nearby have a high chance of being related, that "
